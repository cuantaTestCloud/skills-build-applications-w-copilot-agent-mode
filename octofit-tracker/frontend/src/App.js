        ...
        <Routes>
          ...
          <Route path="/" element={
            <div className="card shadow p-5 text-center">
              <img src="/octofitapp-small.png" alt="OctoFit Logo" className="octofit-logo mb-4" style={{maxWidth: '120px'}} />
              <h1 className="display-4 mb-3">Welcome to <span className="text-primary">OctoFit Tracker</span>!</h1>
              <p className="lead">Track your activities, teams, workouts, and more with a beautiful Bootstrap interface.</p>
